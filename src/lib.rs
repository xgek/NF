...
#[derive(Debug)]
pub struct NFTMintProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NFTMintProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NFTMint processing");
    
    let mut processor = NFTMintProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NFTMintProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NFTMintProcessor::new(false);
